...
class FlowField {
  public:
    ...
    void setRandom();
    void setPerlin();
    void setCustomA(float _randMin, float _randMax);
    void setCustomB(float _randMin, float _randMax);
    void setCustomC(float _randMin, float _randMax);
    void setRandomModA(float _randMin, float _randMax);
